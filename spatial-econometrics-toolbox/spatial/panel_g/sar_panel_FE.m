...
% PURPOSE: ML SAR model estimates for spatial panels 
...
% modified by J. LeSage, December 2020
...
result0 = panel_effects_sar(results,W,nvar,ywith,xwith);
...
function result0 = panel_effects_sar(results,W,nvar,ywith,xwith)
...
if size(sigmat,1) ~= nvar+1
sigmat = sigmat(1:nvar+1,1:nvar+1);
end
